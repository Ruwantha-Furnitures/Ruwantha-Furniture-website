...
import AssignDriverPendingForm from "./common/AssignDriverPendingForm";

function DriverAssignPending() {
  return (
...
export default DriverAssignPending;
