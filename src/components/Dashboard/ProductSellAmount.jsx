...
import ProductSellAmountForm from "./product/product_sell/common/ProductSellAmountForm";

function ProductSellAmount() {
  return (
...
export default ProductSellAmount;
