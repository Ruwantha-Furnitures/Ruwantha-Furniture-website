...
import ProductSellShippingForm from "./common/ProductSellShippingForm";

function ProductSellShipping() {
  return (
...
export default ProductSellShipping;
