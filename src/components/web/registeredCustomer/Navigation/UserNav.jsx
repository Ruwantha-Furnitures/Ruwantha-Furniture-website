            ...
            <Navbar variant="dark" expand="lg" sticky="top" style={{ backgroundColor: '#291B1B', maxWidth: '100%' }}>
                ...
                <Navbar.Collapse id="basic-navbar-nav" >
                    <Nav className="mr-auto">
                        ...
                        <Nav.Link href="/customer_contact-us">Contact Us</Nav.Link>
                    </Nav>
                    <Form inline>
                        <Row>
                            <Col>
                            ...
                            <Col>
                                <Link to="/login" ><button className={NavButtonStyle.btn} style={{ marginTop: '-10px' }} onClick={() => localStorage.clear()}>Logout</button></Link>
                            </Col>
                        </Row>
                    </Form>
                </Navbar.Collapse>
